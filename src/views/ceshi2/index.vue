        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <div class="bfb" :style="{background: ({'即将达到KPI指标': '#339966','达到KPI指标小风险': '#FFCC66','达到KPI指标中风险': '#FF9999','达到KPI指标高风险': '#FF0000'  })[scope.row.amount2] || '' ,}">
                {{ scope.row.amount2 }}
              </div>
<!--              //  判断返回值是正数百分比&&只判断后面两行&#45;&#45;字体绿色+上升箭头-->
<!--              <span style="color: green" v-if="parseFloat(scope.row[scope.column.property]) > 0 && (scope.row.name == '同比增幅' || scope.row.name == '环比增幅')">{{scope.row[scope.column.property]}}↑</span>-->
...
<!--              <div class="bfb" :style="{background: ({'-1': '#C6E0B4','-20': '#C6E0B4'})[scope.row.amount5] || '#FF9999' ,}">-->
              <div class="bfb" :style="{color: scope.row.amount5 < 0 ? '#C6E0B4' : '#FF9999',}">
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <div class="bfb" :style="{background: ({'9.00%': '#C6E0B4','11.22%': '#C6E0B4'})[scope.row.amount7] || '#FF9999' ,}">
                {{ scope.row.amount7 }}
              </div>
              <!--              //  判断返回值是正数百分比&&只判断后面两行&#45;&#45;字体绿色+上升箭头-->
              <!--              <span style="color: green" v-if="parseFloat(scope.row[scope.column.property]) > 0 && (scope.row.name == '同比增幅' || scope.row.name == '环比增幅')">{{scope.row[scope.column.property]}}↑</span>-->
