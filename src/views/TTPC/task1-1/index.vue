    ...
    <el-dialog title="自动外呼描述" :visible.sync="dialogDescribe2">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-upload
          ...
          :action=" this.baseURL+'/car/readdata/'+this.describe2"
          :headers="headers"
  ...
  methods: {
    ...
    spawnCity(val){
      console.log(val)
        axios({
          method: 'post',
          url: `${this.baseURL}/car/getCarSeriesByBrand`,
          headers: {
    ...
    getProvince(){
      axios({
        method: 'get',
        url: `${this.baseURL}/car/getallprovinces`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    licensePlate() {
      axios({
        method: 'get',
        url: `${this.baseURL}/car/getbrands`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    carSeriesList(val) {
      axios({
        method: 'get',
        url: `${this.baseURL}/car/getCarSeriesByBrand/${val}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    exportFile() {
      this.$confirm('是否确认下载文件', '提示', {
        ...
        axios({
          method: 'post',
          url: this.baseURL + '/car/exportalldatabycondition',
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
    ...
    activation() { //
      if (this.guids.length > 0) {
        ...
        axios({
          method: 'post',
          url: this.baseURL + '/car/defeatactivationbyguidlist',
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
    ...
    manualRecycling() { //
      if (this.guids.length > 0) {
        ...
        axios({
          method: 'post',
          url: this.baseURL + '/car/recoverydatabyguidlist',
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
    ...
    choiceZx() {
      ...
      axios({
        method: 'post',
        url: `${this.baseURL}/car/allocatedatabyguids/${this.oneZx}/${this.readable}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    dataList(data) {
      ...
      axios({
        method: 'post',
        url: `${this.baseURL}/car/getalldatabyconditition`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    record(val) {
      ...
      axios({
        method: 'get',
        url: this.baseURL + '/car/record/getRecordByCarRecordGuid?entityGuid=' + val.guid,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    ranking() {
      axios({
        method: 'post',
        url: this.baseURL + '/car/getcarperformanceranking',
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    get(data) {
      ...
      axios({
        method: 'get',
        url: this.baseURL + '/car/getdetail/' + data,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    alldata() {
      ...
      axios({
        method: 'post',
        url: this.baseURL + '/car/addstatus',
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    modify(value, guid, a) {
      ...
      axios({
        method: 'get',
        url: `${this.baseURL}/car/updatebyguidandfieldnameandvalue/${guid}/${a}/${value}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    swop() {
      ...
      axios({
        method: 'get',
        url: `${this.baseURL}/car/primaryandstandbydataexchange?guid=${this.form.guid}&sparePhone=${this.form.sparePhone}&spareName=${this.form.spareName}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    branch() {
      axios({
        method: 'get',
        url: `${this.baseURL}/user/lockdepartment/${1}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
