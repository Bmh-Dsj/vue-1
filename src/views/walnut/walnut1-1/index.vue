...
<!--                 @change="((val)=>{modify(val,form.guid,'name')})"-->
...
<!--          <h4>填选信息</h4>-->
          ...
          <div class="mBottom" style="display: flex; justify-content: end;flex-wrap: wrap; ">
            ...
            <span>分配時間 : {{ this.form.allocateTime }}</span>
          </div>
          <div class="mBottom">
  ...
  export default {
    ...
    methods: {
      ...
      swop(){
        ...
        axios({
          method: 'get',
          url: `${this.baseURL}/hetao/${this.form.guid}&sparePhone=${this.form.sparePhone}&spareName=${this.form.spareName}`,
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
