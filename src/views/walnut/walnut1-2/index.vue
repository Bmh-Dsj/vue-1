  ...
  <div  v-loading="sc" element-loading-text="上传中">
          ...
          <el-form @keyup.enter.native="fromShow" ref="from" :inline="true" :model="from" class="demo-form-inline">
            <el-form-item style="display: block">
              <div class="buttonDiv">
                ...
                <!--                :action="this.baseURL + '/hetao/admin/readdata'"-->
                <!--                :headers="headers"-->
                ...
                <!--              <el-upload-->
                <!--                class="upload-demo mrr"-->
                <!--                :action="this.baseURL + '/hetao/admin/exceltransferolddata'"-->
                <!--                :headers="headers"-->
                <!--                :show-file-list="false"-->
                <!--                name="file"-->
                <!--                accept =".xls"-->
            ...
            <el-form-item prop="numberDeDuplication">
              <el-switch

                v-model="from.numberDeDuplication"
                active-text="号码去重"
              >
              </el-switch>
            </el-form-item><!-- 联系电话 -->
            ...
            <el-form-item prop="babyName">
              <el-input
                size="small"
                placeholder="孩子姓名"
                v-model="from.babyName">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 孩子姓名 -->
            <el-form-item prop="babySex">
              <el-input
                size="small"
                placeholder="孩子性别"
                v-model="from.babySex">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 孩子性别 -->
            <el-form-item prop="babyAge">
              <el-input
                size="small"
                placeholder="孩子年龄"
                v-model="from.babyAge">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 孩子年龄 -->
            <el-form-item prop="babySchoolAge">
              <el-input
                size="small"
                placeholder="孩子学龄"
                v-model="from.babySchoolAge">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 孩子学龄 -->
            <el-form-item prop="babySchool">
              <el-input
                size="small"
                placeholder="孩子学校"
                v-model="from.babySchool">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 孩子学校 -->
            <el-form-item prop="secondBabyName">
              <el-input
                size="small"
                placeholder="二宝姓名"
                v-model="from.secondBabyName">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 二宝姓名 -->
            <el-form-item prop="secondBabySex">
              <el-input
                size="small"
                placeholder="二宝性别"
                v-model="from.secondBabySex">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 二宝性别 -->
            <el-form-item prop="secondBabyAge">
              <el-input
                size="small"
                placeholder="二宝年龄"
                v-model="from.secondBabyAge">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 二宝年龄 -->
            <el-form-item prop="secondBabySchoolAge">
              <el-input
                size="small"
                placeholder="二宝学龄"
                v-model="from.secondBabySchoolAge">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 二宝学龄 -->
            <el-form-item prop="secondBabySchool">
              <el-input
                size="small"
                placeholder="二宝学校"
                v-model="from.secondBabySchool">
                <i slot="prefix" class="el-input__icon el-icon-search"></i>
              </el-input>
            </el-form-item><!-- 二宝学校 -->
            ...
            <el-form-item>
              <div class="buttonDiv">
                ...
                <!--                class="upload-demo"-->
                <!--                action="http://192.168.2.127:9090/hetao/admin/readdata"-->
                <!--                :headers="headers"-->
                <!--                :show-file-list="false"-->
                <!--                name="file"-->
                <!--                accept =".xls"-->
    ...
    <div class="gdt">
      <div class="table" v-loading="loading">
        <el-table
          ...
          <!--              &lt;!&ndash;              <el-button style="margin-right: 10px;" @click="record(scope.row)" type="primary"&ndash;&gt;-->
          <!--              &lt;!&ndash;                         size="mini">查看&ndash;&gt;-->
          <!--              &lt;!&ndash;              </el-button>&ndash;&gt;-->
          <!--              <el-button @click="editor(scope.row)" type="success"-->
          <!--                         size="mini">已到店-->
          <!--              </el-button>-->
          <!--            </template>-->
          <!--          </el-table-column>-->
    ...
    <el-dialog title="自动外呼描述" :visible.sync="dialogDescribe2">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-upload
          class="upload-demo mrr"
          :action =" this.baseURL+'/hetao/admin/readdata/'+this.describe2"
          :headers="headers"
          :show-file-list="false"
          name="file"
          accept =".xls"
  ...
  data() {
    return {
      ...
      from:{
        ...
        numberDeDuplication:false,//号码去重
  ...
  methods:{
    ...
    exportFile(){
      this.$confirm('是否确认下载文件', '提示', {
        ...
        axios({
          method: 'post',
          url: this.baseURL + '/hetao/admin/exportalldatabycondition',
          headers: {
    ...
    //激活战败
    activation(){ // /hetao/admin/defeatactivationbyguidlist
      if(this.guids.length > 0){
        this.lostLoading = true
        axios({
          method: 'post',
          url: this.baseURL + '/hetao/admin/defeatactivationbyguidlist',
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
    ...
    //手动回收  recoverLoading
    manualRecycling(){ // /hetao/admin/recoverydatabyguidlist
      if(this.guids.length > 0){
        this.recoverLoading = true
        axios({
          method: 'post',
          url: this.baseURL + '/hetao/admin/recoverydatabyguidlist',
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
    ...
    choiceZx(){
      ...
      axios({
        method: 'post',
        // url: this.baseURL + '/hetao/admin/allocatedatabyguids/'+this.oneZx+this.readable,
        url: `${this.baseURL}/hetao/admin/allocatedatabyguids/${this.oneZx}/${this.readable}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
    ...
    distribution(){//tyFp
      ...
      // axios({
      //   method: 'post',
      //   url: 'http://192.168.3.117:9090/hetao/admin/allocatedatabyguids/'+job,
      //   headers: {
      //     "Content-Type": "application/json;charset=UTF-8",
      //     'token': localStorage.token,
      //   },
    ...
    dataList(data){
      ...
      // axios({
      //   method: 'post',
      //   url: 'http://192.168.2.127:9090/hetao/admin/getalldatabyconditition',
      //   headers: {
      //     "Content-Type": "application/json;charset=UTF-8",
      //     'token': localStorage.token,
      //   },
    ...
    record(val){
      ...
      axios({
        method: 'get',
        url: this.baseURL + '/hetao/hetaorecord/getRecordByHeTaoGuid?heTaoGuid='+val.guid,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
