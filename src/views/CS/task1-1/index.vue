  ...
  <div  v-loading="sc" element-loading-text="上传中">
          ...
          <el-form @keyup.enter.native="fromShow" ref="from" :inline="true" :model="from" class="demo-form-inline">
            <el-form-item style="display: block">
              <div class="buttonDiv">
                ...
                <!--                :action="this.baseURL + '/demo/demo/readdata'"-->
                <!--                :headers="headers"-->
                ...
                <!--              <el-upload-->
                <!--                class="upload-demo mrr"-->
                <!--                :action="this.baseURL + '/demo/demo/exceltransferolddata'"-->
                <!--                :headers="headers"-->
                <!--                :show-file-list="false"-->
                <!--                name="file"-->
                <!--                accept =".xls"-->
            ...
            <el-form-item>
              <div class="buttonDiv">
                ...
                <!--                class="upload-demo"-->
                <!--                action="http://192.168.2.127:9090/demo/demo/readdata"-->
                <!--                :headers="headers"-->
                <!--                :show-file-list="false"-->
                <!--                name="file"-->
                <!--                accept =".xls"-->
    ...
    <el-dialog title="自动外呼描述" :visible.sync="dialogDescribe2">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-upload
          class="upload-demo mrr"
          :action =" this.baseURL+'/demo/demo/readdata/'+this.describe2"
          :headers="headers"
          :show-file-list="false"
          name="file"
          accept =".xls"
  ...
  methods:{
    ...
    exportFile(){
      this.$confirm('是否确认下载文件', '提示', {
        ...
        axios({
          method: 'post',
          url: this.baseURL + '/demo/demo/exportalldatabycondition',
          headers: {
    ...
    //激活战败
    activation(){ // /demo/demo/defeatactivationbyguidlist
      if(this.guids.length > 0){
        this.lostLoading = true
        axios({
          method: 'post',
          url: this.baseURL + '/demo/demo/defeatactivationbyguidlist',
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
    ...
    //手动回收  recoverLoading
    manualRecycling(){ // /demo/demo/recoverydatabyguidlist
      if(this.guids.length > 0){
        this.recoverLoading = true
        axios({
          method: 'post',
          url: this.baseURL + '/demo/demo/recoverydatabyguidlist',
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
    ...
    choiceZx(){
      ...
      axios({
        method: 'post',
        // url: this.baseURL + '/demo/demo/allocatedatabyguids/'+this.oneZx+this.readable,
        url: `${this.baseURL}/demo/demo/allocatedatabyguids/${this.oneZx}/${this.readable}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
    ...
    distribution(){//tyFp
      ...
      // axios({
      //   method: 'post',
      //   url: 'http://192.168.3.117:9090/demo/demo/allocatedatabyguids/'+job,
      //   headers: {
      //     "Content-Type": "application/json;charset=UTF-8",
      //     'token': localStorage.token,
      //   },
    ...
    dataList(data){
      ...
      axios({
        method: 'post',
        // url: this.baseURL + '/demo/demo/allocatedatabyguids/'+this.oneZx+this.readable,
        url: `${this.baseURL}/demo/demo/getalldatabyconditition`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
      ...
      // axios({
      //   method: 'post',
      //   url: 'http://192.168.2.127:9090/demo/demo/getalldatabyconditition',
      //   headers: {
      //     "Content-Type": "application/json;charset=UTF-8",
      //     'token': localStorage.token,
      //   },
    ...
    record(val){
      ...
      axios({
        method: 'get',
        url: this.baseURL + '/demo/demo-record/getRecordByDemoRecordGuid?entityGuid='+val.guid,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
