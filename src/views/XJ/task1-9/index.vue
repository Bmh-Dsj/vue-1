...
<!--                      <el-option label="女" value="女"></el-option>-->
<!--                    </el-select>-->
<!--                    &lt;!&ndash;                <el-input placeholder="备用联系人性别" v-model="form.spareSex"></el-input>&ndash;&gt;-->
<!--                  </el-form-item>-->
                  <br>
...
<!--                  </el-form-item>-->
                  <el-form-item style="width: 23%;" label="孩子学龄">
                    <el-input placeholder="孩子学龄"
                              v-model="form.babySchoolAge"></el-input>
                  </el-form-item>
            ...
            if (this.allWorkDialog !== true) {
              axios({
                ...
                if (res.data == '') {
                  ...
                  this.form.call = [] //接通状态填充
                  this.form.call = [13,14] //接通状态填充
                  this.form.statusId = 14 //接通状态填充
                  this.form.Business = []
