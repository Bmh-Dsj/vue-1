        ...
        <div class="right-w1 jbkxg wb" style="border-right: none">
          ...
          <div>
            <el-form class="tablewb" :label-position="titleLeft" :inline="true" size="mini" ref="form" :model="form" label-width="80px">
              ...
              <br>
              <el-form-item label-width="120px" style="width: 20%;" label="备用联系人姓名">
              ...
              <br>
              <el-form-item style="width: 20%;" label="孩子姓名">
...
<!--                </el-select>-->
<!--              </el-form-item>-->
              <el-form-item style="width: 20%;" label="孩子学龄">
...
<!--              </el-form-item>-->
              <br>
              <el-form-item style="width: 30%;" label="省份">
                <el-input placeholder="省份" v-model="form.province"></el-input>
              </el-form-item>
              <el-form-item style="width: 30%;" label="城市">
                <el-input placeholder="城市" v-model="form.city"></el-input>
              </el-form-item>
              <el-form-item style="width: 30%;" label="区域">
  ...
  methods: {
    ...
    blackList(){
      this.$confirm('此操作无法撤销, 是否继续?', '提示', {
        ...
        axios({
          method: 'get',
          url: `${this.baseURL}/xj/admin/adddatabyphoneanddepartguid/${this.onedata.phone}`,
          headers: {
    ...
    alldata(){
      ...
      if(this.form.Business.length > 0  && this.form.call.length > 0){
            this.loadingT = true
    ...
    getlist(data){
      ...
      axios({
        method: 'post',
        url: `${this.baseURL}/xj/admin/getneedhandledata`,
        headers: {
          "Content-Type": "application/json;",
          'token': localStorage.token,
        },
    ...
    get(data){
      ...
      // axios({
      //   method: 'get',
      //   url: 'http://192.168.3.117:9090/xj/admin/getdetail/'+data,
      //   headers: {
