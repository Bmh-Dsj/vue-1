  ...
  <div  v-loading="sc" element-loading-text="上传中">
          ...
          <el-form @keyup.enter.native="fromShow" ref="from" :inline="true" :model="from" class="demo-form-inline">
            <el-form-item style="display: block">
              <div class="buttonDiv">
                ...
                <!--                :action="this.baseURL + '/xj/admin/readdata'"-->
                <!--                :headers="headers"-->
                ...
                <!--              <el-upload-->
                <!--                class="upload-demo mrr"-->
                <!--                :action="this.baseURL + '/xj/admin/exceltransferolddata'"-->
                <!--                :headers="headers"-->
                <!--                :show-file-list="false"-->
                <!--                name="file"-->
                <!--                accept =".xls"-->
            ...
            <el-form-item>
              <div class="buttonDiv">
                ...
                <!--                class="upload-demo"-->
                <!--                action="http://192.168.2.127:9090/xj/admin/readdata"-->
                <!--                :headers="headers"-->
                <!--                :show-file-list="false"-->
                <!--                name="file"-->
                <!--                accept =".xls"-->
    ...
    <el-dialog title="自动外呼描述" :visible.sync="dialogDescribe2">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-upload
          class="upload-demo mrr"
          :action =" this.baseURL+'/xj/admin/readdata/'+this.describe2"
          :headers="headers"
          :show-file-list="false"
          name="file"
          accept =".xls"
  ...
  methods:{
    ...
    exportFile(){
      this.$confirm('是否确认下载文件', '提示', {
        ...
        axios({
          method: 'post',
          url: this.baseURL + '/xj/admin/exportalldatabycondition',
          headers: {
    ...
    //激活战败
    activation(){ // /xj/admin/defeatactivationbyguidlist
      if(this.guids.length > 0){
        this.lostLoading = true
        axios({
          method: 'post',
          url: this.baseURL + '/xj/admin/defeatactivationbyguidlist',
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
    ...
    //手动回收  recoverLoading
    manualRecycling(){ // /xj/admin/recoverydatabyguidlist
      if(this.guids.length > 0){
        this.recoverLoading = true
        axios({
          method: 'post',
          url: this.baseURL + '/xj/admin/recoverydatabyguidlist',
          headers: {
            "Content-Type": "application/json;charset=UTF-8",
            'token': localStorage.token,
          },
    ...
    choiceZx(){
      ...
      axios({
        method: 'post',
        // url: this.baseURL + '/xj/admin/allocatedatabyguids/'+this.oneZx+this.readable,
        url: `${this.baseURL}/xj/admin/allocatedatabyguids/${this.oneZx}/${this.readable}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
    ...
    distribution(){//tyFp
      ...
      // axios({
      //   method: 'post',
      //   url: 'http://192.168.3.117:9090/xj/admin/allocatedatabyguids/'+job,
      //   headers: {
      //     "Content-Type": "application/json;charset=UTF-8",
      //     'token': localStorage.token,
      //   },
    ...
    dataList(data){
      ...
      axios({
        method: 'post',
        url: `${this.baseURL}/xj/admin/getalldatabyconditition`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
      ...
      // axios({
      //   method: 'post',
      //   url: 'http://192.168.2.127:9090/xj/admin/getalldatabyconditition',
      //   headers: {
      //     "Content-Type": "application/json;charset=UTF-8",
      //     'token': localStorage.token,
      //   },
    ...
    record(val){
      ...
      axios({
        method: 'get',
        url: this.baseURL + '/xj/xjrecord/getRecordByHeTaoGuid?heTaoGuid='+val.guid,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    ranking(){
      axios({
        method: 'post',
        url: this.baseURL + '/xj/admin/getxjperformanceranking',
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    get(data){
      ...
      axios({
        method: 'get',
        url: this.baseURL + '/xj/admin/getdetail/'+data,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    alldata(){
      ...
      axios({
        method: 'post',
        url: this.baseURL + '/xj/admin/addstatus',
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    modify(value,guid,a){
      ...
      axios({
        method: 'get',
        url: `${this.baseURL}/xj/admin/updatebyguidandfieldnameandvalue/${guid}/${a}/${value}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    swop(){
      ...
      axios({
        method: 'get',
        url: `${this.baseURL}/xj/admin/primaryandstandbydataexchange?guid=${this.form.guid}&sparePhone=${this.form.sparePhone}&spareName=${this.form.spareName}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
