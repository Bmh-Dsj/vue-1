    ...
    <div class="head">
      ...
      <div class="basis">
        ...
        <el-form label-position="left" :inline="true" size="mini" ref="form" :model="from" label-width="70px">
          ...
          <br>
          <el-form-item style="width: 30%;" label="姓名">
            <el-input placeholder="姓名" v-model="from.name"></el-input>
          </el-form-item>
          <el-form-item style="width: 30%;" label="联系方式">
            <el-input placeholder="联系方式" v-model="from.phone"></el-input>
          </el-form-item>
          <el-form-item style="width: 30%;" label="性别">
            <el-select v-model="from.sex" placeholder="性别">
          ...
          <el-form-item style="width: 23%;" label="车辆品牌">
            <el-input placeholder="车辆品牌" v-model="from.brand"></el-input>
<!--            <el-select @change="carSeriesList" v-model="from.brand" placeholder="车辆品牌">-->
<!--              <el-option-->
...
<!--            </el-select>-->
          ...
          <el-form-item style="width: 23%;" label="车系">
            <el-input placeholder="车系" v-model="from.family"></el-input>
<!--            <el-select v-model="from.family" placeholder="车系">-->
<!--              <el-option-->
...
<!--            </el-select>-->
      ...
      <div class="optional">
        ...
        <div class="marginB">
          ...
          <br>
          <!--         <span class="writing writingS">上次跟进时间：{{this.followUpTime}}</span>-->
          <!--         <span class="writingS">{{this.followUpTime}}</span>-->
        </div>
        <div class="marginB">
        ...
        <div class="color marginB">
          <span class="writing">个人标签：</span>
          <span class="statusWidth">
              <el-radio-group @change="colorValue" size="mini" :fill="this.from.personalLabel"
                              v-model="from.personalLabel">
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.from.sourceChannel !== '' && this.from.phone !== '') {
        axios({
          method: 'post',
          url: `${this.baseURL}/carac/addticket`,
          headers: {
            "Content-Type": "application/json;",
            'token': localStorage.token,
          },
