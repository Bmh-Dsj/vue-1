            ...
            <div class="czjlDid">
              ...
              <div class="buttonsDiv">
                ...
                <div class="buttonTDiv">
                  ...
                  <el-button :loading="loadingT" :disabled="submit" @click="verifySubmission" type="primary">提交工单</el-button>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    //提交工单验证
    verifySubmission() {
      if (this.form.toAc || this.form.toTt) {
        this.$confirm(`
          ${this.form.toAc ? '是否确定传送新车?' : ''}

          ${this.form.toTt ? '是否确定检测数据?' : ''}
          `, '提示', {
    ...
    blackList() {
      this.$confirm('此操作无法撤销, 是否继续?', '提示', {
        ...
        axios({
          method: 'get',
          url: `${this.baseURL}/carac/adddatabyphoneanddepartguid/${this.onedata.phone}`,
          headers: {
