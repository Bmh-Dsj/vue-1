  ...
  <div>
    ...
    <div class="left">
      <div class="sousuo">
        <el-collapse accordion>
          <el-collapse-item>
            ...
            <el-form @keyup.enter.native="onSubmit" ref="formInline" size="mini" :inline="true" :model="formInline"
      ...
      <div class="gundong" v-loading="loading">
        <div :class="acg == index ? 'selectedBorder' : ''" :style="`background: ${qq.background}`"
             @click="dataxq(index)" v-for="(qq,index) in data" :key="index" class="namehm">
          ...
          <div class="noLineBreak">
            <span>剩余时间：{{ qq.time }}</span>
            <!--            <img src="../../icons/svg/new.png">-->
            <!--            <span>省份：{{ qq.province }}</span>-->
            <!--            <span>城市：{{ qq.city }}</span>-->
            <!--            <span>意向度：{{qq.intentionality?qq.intentionality:'无' }} </span>-->
            <!--            <span>状态：{{ qq.status?qq.status:'无' }}</span>-->
          ...
          <div class="label">
            ...
            <img style="float: right" :width="qq.size" :src="qq.urlAddress" alt="">
            <!--            <img width="100%" src="../../icons/svg/new.png" alt="">-->
    ...
    <div class="right" v-loading="loading2">
        ...
        <div class="flex" style="width: 100%;">
          <div style="width:100%;">
            ...
            <div class="right-s" style="width:100%; border-bottom: 1px #666 solid;background: rgba(245,245,245,0.5)">
              <div class="right-sd"><span>任务ID：</span><span style="font-weight: 900">123456</span></div>
              <div class="right-sd"><span>潜客姓名：</span><span style="font-weight: 900">王先生</span></div>
              <div class="right-sd"><span>手机号：</span><span style="font-weight: 900">133****8235</span></div>
              <div class="right-sd"><span>潜客来源：</span><span style="font-weight: 900">留资-易车网</span></div>
              <div class="right-sd"><span>购车意向：</span><span style="font-weight: 900">科沃兹</span></div>
              <div class="right-sd"><span>销售顾问：</span><span style="font-weight: 900">王思南</span></div>

              <div class="right-sd"><span>所属门店：</span><span style="font-weight: 900">中山创志雪佛兰</span></div>
              <div class="right-sd"><span>潜客级别：</span><span style="font-weight: 900"></span></div>
              <div class="right-sd"><span>手机号地区：</span><span style="font-weight: 900">广东省--中山市</span></div>
              <div class="right-sd"><span>留资时间：</span><span style="font-weight: 900">2021-05-05 22:44</span></div>
              <div class="right-sd"><span>备注：</span><span style="font-weight: 900">客户端上传</span></div>
              <div class="right-sd"><span>销售电话：</span><span style="font-weight: 900">13750031564</span></div>
      ...
      <div class="right-d">
        <!--          上          -->
        <div style="width: 100%;">
          <div style="width: 100%; padding: 10px 0; border-bottom: 1px #cccccc solid">
              <el-steps style="width:100%;font-size: 12px" align-center :active="active" finish-status="success">
                <el-step title="任务创建"></el-step>
                <el-step title="首次跟进"></el-step>
                <el-step title="邀约进店"></el-step>
                <el-step title="进店提醒"></el-step>
                <el-step title="确认进店"></el-step>
                <el-step title="展厅回访"></el-step>
                <el-step title="确认成交"></el-step>
                <el-step title="成交回访"></el-step>
        ...
        <div style="width: 100%;display: flex">
          <div style="display: flex; width: 75%;">
            <div class="right-w1 jbkxg wb" style="border-right: none">
              <!--          <p>客户基础信息</p>-->
              <div>
                <el-form :rules="bit" size="small" ref="form" :model="form" label-width="100px">
                  ...
                  <el-form-item label="潜客级别" prop="sex">
                    <el-input v-model="form.sex" placeholder="潜客级别"></el-input>
                  </el-form-item>
                  <el-form-item label="建议新级别" prop="new">
                    <!--                    <el-input v-model="form.new" placeholder="建议新级别"></el-input>-->
                    <el-select style="width: 100%;" v-model="form.new" placeholder="请选择">
                      <el-option
                  ...
                  <el-form-item label="意向车型" prop="new">
                    <el-input v-model="form.new" placeholder="意向车型"></el-input>
                  </el-form-item>
                  <el-form-item label="对比车型" prop="new">
                    <el-input v-model="form.new" placeholder="意向车型"></el-input>
                  </el-form-item>
                  <el-form-item label="购车时间" prop="new">
                    <el-select style="width: 100%;" v-model="form.new" placeholder="请选择">
                      <el-option
                        v-for="item in options"
                        :key="item.value"
                  ...
                  <el-form-item style="width: 80%" label="上牌地区" prop="radio">
                    <el-radio-group v-model="form.radio">
                      <el-radio :label="1">本市</el-radio>
                      <el-radio :label="2">本省</el-radio>
                      <el-radio :label="3">外省</el-radio>
                      <el-radio :label="4">未明确</el-radio>
                    </el-radio-group>
                  </el-form-item>
                  <el-form-item label="是否有牌照" prop="radio">
                    <el-radio-group v-model="form.radio">
                  ...
                  <el-form-item label="是否已看车" prop="radio">
                    <el-radio-group v-model="form.radio">
                      <el-radio :label="1">是</el-radio>
                      <el-radio :label="2">否</el-radio>
                      <el-radio :label="4">未明确</el-radio>
                  ...
                  <el-form-item style="width: 80%" label="是否置换" prop="radio">
                    <el-radio-group v-model="form.radio">
                      <el-radio :label="1">置换</el-radio>
                      <el-radio :label="2">新购</el-radio>
                      <el-radio :label="3">增购</el-radio>
                      <el-radio :label="4">未明确</el-radio>
                    </el-radio-group>
                  </el-form-item>
                  <el-form-item style="width: 80%" label="付款方式" prop="radio">
                    <el-radio-group v-model="form.radio">
            ...
            <div style="padding-top: 5px;" class="wb xtxxDiv">
              <!--          <h4>填选信息</h4>-->
              <el-form :rules="bit" size="small" ref="form" :model="form" label-width="70px">

                <el-form-item label="到店意向" prop="new">
                  <!--                    <el-input v-model="form.new" placeholder="建议新级别"></el-input>-->
                  <el-select style="width: 100%;" v-model="form.new" placeholder="请选择">
                    <el-option
                      v-for="item in options"
                ...
                <el-form-item label="反馈时效" prop="new">
                  <!--                    <el-input v-model="form.new" placeholder="建议新级别"></el-input>-->
                  <el-date-picker
                    size="mini"
                ...
                <el-form-item style="color: red" label="本次总结" prop="new">
                  <!--                    <el-input v-model="form.new" placeholder="建议新级别"></el-input>-->
                  <el-input
                    style="width: 100%;"
                    type="textarea"
              ...
              <!--                &lt;!&ndash;              v-model="form.seatNote">&ndash;&gt;-->
              <!--                &lt;!&ndash;            </el-input>&ndash;&gt;-->
              <!--                <div class="history">-->
            ...
            <div style="padding-top: 5px;" class="czjlDid">
              <el-form :rules="bit" size="small" ref="form" :model="form" label-width="100px">

                <el-form-item label="下次跟进" prop="new">
                  <el-radio-group v-model="form.radio">
                    <el-radio-button label="持续跟进"></el-radio-button>
                    <el-radio-button label="战败任务"></el-radio-button>
                  </el-radio-group>
                </el-form-item>
                <el-form-item label="下次跟进目的">
                  <el-input v-model="form.new" placeholder="下次跟进目的"></el-input>
                </el-form-item>
                <el-form-item label="下次跟进人" prop="new">
                  <el-select style="width: 100%;" v-model="form.new" placeholder="请选择">
                    <el-option
                      v-for="item in options"
                      :key="item.value"
                ...
                <el-form-item label="跟进截至时间" prop="new">
                  <el-date-picker
                    size="mini"
                    v-model="form.followUpTime"
                    type="datetime"
                ...
                <el-form-item style="color: red" label="锁定截至时间" prop="new">
                  <el-checkbox v-model="form.new"></el-checkbox>
                </el-form-item>
              </el-form>
              <!--              <div class="record">-->
          ...
          <div style="width: 25%;position: relative;">
            <div style="text-align: center">
              <p style="font-size: 20px;font-weight: 900;">王思南</p>
              <p>13232823381</p>
              <sapn style="display: inline-block;background: #409EFF;color:white;padding: 3px 5px;border-radius: 3px">上海尤尼科科技有限公司</sapn>
            </div>
            <div style="display:flex;text-align: center; margin-top: 20px;">
              <div style="width: 33%;">
                <span style="color:#66B1FF;font-size: 25px;font-weight: 900;">
                  46
                </span><br>
            ...
            <div style="position: absolute;bottom: 0;width: 100%;">
              <div style="margin: 15px 0;">
                <el-button style="width: 100%;"  type="success"><i class="el-icon-phone el-icon--right"></i> 拨打电话</el-button>
              </div>
              <div style="margin: 15px 0;">
                <el-button style="width: 100%;" type="primary"><i class="el-icon-s-promotion el-icon--right"></i> 提交任务</el-button>
              </div>
            </div>
          </div>
        </div>
  ...
  data() {
    return {
      bit: {
        ...
        radio: [{required: true, message: '性别不能为空', trigger: 'blur'}],
        new: [{required: true, message: '潜客级别不能为空', trigger: 'blur'}],
      },
      ...
      data: [
        {
          ...
          store: '中山创志雪佛兰',
          time: '1:5',
          urlAddress: require('../../icons/svg/new.png'),
          background: '#62C3D0',
          size:'80%',
        },
        {
        ...
        },
        {
          ...
          store: '中山创志雪佛兰',
          time: '1:5',
          urlAddress: require('../../icons/svg/A.png'),
          background: '#F56C6C',
          size:'30%',
        },
        {
        ...
        },
        {
          ...
          store: '中山创志雪佛兰',
          time: '1:5',
          urlAddress: require('../../icons/svg/B.png'),
          background: '#E1F3D8',
          size:'30%',
        },
        {
  ...
  methods: {
    ...
    blackList() {
      this.$confirm('此操作无法撤销, 是否继续?', '提示', {
        ...
        axios({
          method: 'get',
          url: `${this.baseURL}/hetao/admin/adddatabyphoneanddepartguid/${this.onedata.phone}`,
          headers: {
      ...
      if (this.form.addWechat !== '' && this.form.Business.length > 0 && this.form.call.length > 0) {
        if (this.form.intentionality !== '') {
          if (this.form.followUpTime !== null) {
            this.loadingT = true
            this.$store.dispatch('user/htgongdtj', this.form).then(res => {
              this.sftjrw = true
              this.sfbddh = false
              this.bddh = '拨打电话'
              this.loadingT = false
    ...
    dphone() {
      if (this.bddh == '拨打电话') {
        ...
        axios({
          method: 'get',
          url: `${this.baseURL}/freeswitch/breakPhone/${this.form.calleeId}`,
          headers: {
            "Content-Type": "application/json;",
            'token': localStorage.token,
          },
    ...
    //   this.loading = true
    //   this.loading2 = true
    //   this.$store.dispatch('user/htgdList',data).then(res=>{
    //     console.log(res)
    //     this.loading = false
    ...
    get(data) {
      this.loading2 = true
      this.$store.dispatch('user/htgdoneList', data).then(res => {
        this.loading2 = false
        console.log(res)
      ...
      // axios({
      //   method: 'get',
      //   url: 'http://192.168.3.117:9090/hetao/admin/getdetail/'+data,
      //   headers: {
    ...
    modify(value, guid, a) {
      ...
      axios({
        method: 'get',
        url: `${this.baseURL}/hetao/admin/updatebyguidandfieldnameandvalue/${guid}/${a}/${value}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    swop() {
      ...
      axios({
        method: 'get',
        url: `${this.baseURL}/hetao/admin/primaryandstandbydataexchange?guid=${this.form.guid}&sparePhone=${this.form.sparePhone}&spareName=${this.form.spareName}`,
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
    ...
    ranking() {
      axios({
        method: 'post',
        url: this.baseURL + '/hetao/admin/gethetaoperformanceranking',
        headers: {
          "Content-Type": "application/json;charset=UTF-8",
          'token': localStorage.token,
        },
